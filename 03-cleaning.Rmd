...
Then, we create dfs for all tracks, artist, and albums
...
```{r}
# create a df of info for distinct tracks 
...
Use spotify API to get popularity info for tracks, albums, and artists.
...
save(all_tracks_info, file = "tracks_info.RData")
save(all_artists_info, file = "artists_info.RData")
save(all_albums_info, file = "albums_info.RData")
```
